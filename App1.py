...
if st.button("Solve"):
    ...
    if params:
        ...
        st.write(f"- **Corn Market (Original):** Price: ${price_eq_corn}, Quantity: {quantity_eq_corn} units")

        st.write(f"- **Corn Market (Producer Pays):** Price: ${price_eq_corn_prod_pay}, Quantity: {quantity_eq_corn_prod_pay} units")
        ...
        surplus_corn = pd.DataFrame({

            "Scenario": ["Original Corn Market", "Corn Market (Producer Pays)", "Difference"],
